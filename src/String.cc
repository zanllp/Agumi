...
String::String(JsValue arg) : string(arg.ToString()) {}

String::String(int arg) : string(to_string(arg)) {}

String::String(unsigned long arg) : string(to_string(arg)) {}

String::String(double arg) : string(double2stringEarse0(arg)) {}
